...
namespace LibraryManagementSystem
{
    ...
    {
        SqlConnection connect = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\HP\Documents\library.mdf;Integrated Security=True;Connect Timeout=30");
            ...
            else
            {
                if (connect.State == ConnectionState.Closed)
                {
                    try
                    {
                        ...
                        string path = Path.Combine(@"C:\Users\HP\Documents\LibraryManagementSystem\Books_Directory" +
